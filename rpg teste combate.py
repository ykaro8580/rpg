...
def calcular_dano(tipo_ataque, elemento_ataque, inimigo, ataque_fisico, golpes):
    for golpe in golpes:
...
golpes = ["golpe fisico", "Golpe leve", "Golpe normal", "Golpe pesado", "Fogo", "Agua", "Terra", "Ar"]



personagem["nome"] = input("Digite o nome do personagem: ")
while True:
    personagem["classe"] = input("Escolha a classe do personagem (Mago/Guerreiro/Druida/Arqueiro): ")
    if personagem["classe"].lower() == "mago":
        ...
        personagem["vida"] = personagem["vida max"]
        personagem["dano fisico"] = 10
        personagem["dano magico"] = 5
        personagem["elemento_base"] = "Ar"
        personagem["fraqueza"] = "Fogo"
        inventario.append("Arco do Arqueiro")
        break
    else:
        limpar_tela()
        print("\nClasse inválida! Escolha entre Mago, Guerreiro, Druida ou Arqueiro.\n")
